...
public class SceneMgr
{
    ...
    public void SwitchingScene(SceneType sceneType, params object[] sceneArgs)
    {
        if(current != null)
        {
            ...
            {
                Debug.LogError("试图切换场景至当前场景：" + sceneType.ToString());
                return;
            }
        }
    ...
    private void ShowScene(SceneType sceneType,params object[] sceneArgs)
    {
        ...
        else
        {
            ...
            current = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/Scripts/Core/View/SceneMgr.cs (132,23)", sceneType.ToString()) as SceneBase; //sceneType.tostring等于该场景的classname
